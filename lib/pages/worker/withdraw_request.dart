...
class _RequestWithdrawState extends State<RequestWithdraw> {
  ...
  void initState() {
    ...
    getUserBalance();
    _futureWithdraws = _withdrawService.getRequestByOwner(
        userProvider.token!, userProvider.uid!);
  }
  ...
  Future<void> getUserBalance() async {
    ...
    try {
      ...
      if (user != null) {
        setState(() {
          balance =
              user.balance; // Assuming 'balance' is a property in UserData
        });
      } else {
        setState(() {
          balance = 'No balance';
          ...
          child: Column(
            ...
            children: [
              ...
              isLoading
                  ...
                  : MyButton(
                      onTap: submitRequest, buttonText: 'Submit Request'),
              const SizedBox(height: 20),
              Expanded(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Padding(
                            ...
                            child: ReqRow(
                              ...
                              onCheck: () => {print(withdraws.withdrawId)},
                            ),
                          );
                        },
                      );
